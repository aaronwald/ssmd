    ...
    await db
      ...
      .onConflictDoUpdate({
        ...
        set: {
          ...
          orderPriceMinTickSize: sql`excluded.order_price_min_tick_size`,
          orderMinSize: sql`excluded.order_min_size`,
...
export async function listConditions(
  ...
  return await db
    .select({
      ...
      acceptingOrders: polymarketConditions.acceptingOrders,
      eventId: polymarketConditions.eventId,
      negRisk: polymarketConditions.negRisk,
      description: polymarketConditions.description,
      orderPriceMinTickSize: polymarketConditions.orderPriceMinTickSize,
      orderMinSize: polymarketConditions.orderMinSize,
