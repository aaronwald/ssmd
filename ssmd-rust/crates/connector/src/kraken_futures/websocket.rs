...
//! - Ping: every 15s (reduced from 30s to prevent Kraken proxy disconnects)
...
const READ_TIMEOUT_SECS: u64 = 90; // 6x ping interval — generous to avoid false read timeouts
