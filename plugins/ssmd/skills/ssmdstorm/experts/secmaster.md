...
## Focus Area
Market metadata management: events, markets, series, fees, lifecycle, CDC, Redis cache
...
## When to Select
- Secmaster sync issues
- Database schema changes for market data
- CDC pipeline work
- Redis cache design
- Lifecycle event handling
- Market/series/event data queries
