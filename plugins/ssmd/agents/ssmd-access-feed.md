---
name: ssmd-access-feed
description: |
  Trading APIs: orderbook data, order placement, fills, positions, authenticated channels. Use when: orderbook data integration, order placement API, fill/position tracking, trading strategy implementation, market access authentication, fee calculation logic, risk management.
